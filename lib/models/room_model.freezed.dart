...
mixin _$RoomModel {
  ...
  @JsonKey(name: 'room_icon_url')
  String get roomIconUrl => throw _privateConstructorUsedError;
...
abstract class $RoomModelCopyWith<$Res> {
  ...
  $Res call(
      {String id,
      String name,
      @JsonKey(name: 'room_icon_url') String roomIconUrl});
}
    ...
    return _then(_value.copyWith(
      ...
      name: null == name
          ...
          : name // ignore: cast_nullable_to_non_nullable
              as String,
      roomIconUrl: null == roomIconUrl
          ? _value.roomIconUrl
          : roomIconUrl // ignore: cast_nullable_to_non_nullable
              as String,
    ) as $Val);
  }
}
...
/// @nodoc
@JsonSerializable()
class _$RoomModelImpl with DiagnosticableTreeMixin implements _RoomModel {
  const _$RoomModelImpl(
      {required this.id,
      required this.name,
      @JsonKey(name: 'room_icon_url') required this.roomIconUrl});
  ...
  @override
  @JsonKey(name: 'room_icon_url')
  final String roomIconUrl;

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'RoomModel(id: $id, name: $name, roomIconUrl: $roomIconUrl)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('roomIconUrl', roomIconUrl));
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.roomIconUrl, roomIconUrl) ||
                other.roomIconUrl == roomIconUrl));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, roomIconUrl);
...
abstract class _RoomModel implements RoomModel {
  const factory _RoomModel(
          ...
          @JsonKey(name: 'room_icon_url') required final String roomIconUrl}) =
      _$RoomModelImpl;
